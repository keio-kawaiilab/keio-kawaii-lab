...
check(/start=moment\(o\.applyStart,false\),end=moment\(o\.applyEnd,true\),soldOut=.*?,ended=soldOut\|\|\(!!end&&end<now\)/.test(page), 'ticket start/end moments are not compared with the current time');
