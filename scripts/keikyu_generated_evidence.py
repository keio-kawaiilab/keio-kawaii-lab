...
MARKER = "same-printed-column-spans-both-sides-of-sengakuji"
ALLOWED_PAIRS = {
...
def apply_generated_evidence(
    ...
    for entry in payload.get("entries") or []:
        ...
        if entry.get("boundaryId") != BOUNDARY_ID or MARKER not in evidence:
            reason = "missing-official-column-marker"
        ...
        if key not in seen:
            ...
            output.append({
                ...
                "evidence": ["keikyu-official-connection-timetable-same-column", eid],
